...
int graph_manual_test1()
{
    ...
    Zoom zoom;
    GUI gui(gfx, zoom, 800, 600, "graph_manual_test1");
    Button closeOkBtn(gfx, zoom, 10, 10, 100, 30, "Ok");
    Button button(gfx, zoom, 10, 10, 80, 30, "Hello");
    Button button2(gfx, zoom, 110, 10, 80, 30, "Click!");
    graph_manual_test1_button2Ptr = &button2;
    Frame frame2(gfx, zoom, 320, 100, 200, 200);
    graph_manual_test1_frame2Ptr = &frame2;
    Button lbtn(gfx, zoom, 50, 50, 100, 30, "Hello");
    ...
    Frame frame(gfx, zoom, 100, 100, 200, 200);
    // frame.fixed = true;    
    button2.addTouchHandler(graph_manual_test1_doit);
    Button button3(gfx, zoom, 210, 10, 80, 30, "Sticky");
    button3.setSticky(true);
    Button button4(gfx, zoom, 310, 10, 80, 30, "Hello4");
    Button button5(gfx, zoom, 10, 50, 250, 50, "Big Willy");
    Button button6(gfx, zoom, 210, 210, 80, 30, "Close");
    button6.addTouchHandler(graph_manual_test1_close);
    Label label1(gfx, zoom, 100, 130, 100, 20, "Label1");
    frame.child(button);
    frame.child(button2);
    frame.child(button3);
    frame.child(button4);
